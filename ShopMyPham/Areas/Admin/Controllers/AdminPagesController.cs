...
namespace ShopMyPham.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Thumb,Status,Title,MetaDesc,MetaKey,Alias,CreatedDate,Ordering")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShopMyPhamContext.Pages'  is null.");
            }
            var page = await _context.Pages.FindAsync(id);
            if (page != null)
            {
